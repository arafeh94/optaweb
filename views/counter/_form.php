...
<?= $form->field($model, 'zone_id')->widget(\kartik\select2\Select2::classname(), [
...
<?= $form->field($model, 'unavailabilityPeriodStartTime')->widget(\kartik\datetime\DateTimePicker::className(), \app\components\Extensions::picker()) ?>
<?= $form->field($model, 'unavailabilityPeriodEndTime')->widget(\kartik\datetime\DateTimePicker::className(), \app\components\Extensions::picker()) ?>
